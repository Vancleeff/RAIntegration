...
public:
    ...
    TEST_METHOD(TestOnShiftClickThirtyTwoBit)
    {
        ...
        // Shift click on the first dword containing 0x80012345 should lead to address 0x00012345 as the conversion
        // keeps only the same number of nibbles as the Max address from console context (PSX : 1FFFFF)
        viewer.SetAddress(0);
